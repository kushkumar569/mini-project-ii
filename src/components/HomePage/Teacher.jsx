    ...
    useEffect(() => {
        const fetchEmail = async () => {
            try {
                ...
                const response = await fetch(`https://mini-project-ii-ypu6.onrender.com/me`, {
                    method: "GET",
                    credentials: "include",
                    headers: {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const response = await fetch(`https://mini-project-ii-ypu6.onrender.com/class/data`, {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                    },
                ...
                if (data.matchedClasses.length === 0) {
                    ...
                    const set = async () => {
                        try {
                            const response = await fetch(`https://mini-project-ii-ypu6.onrender.com/setData/set`, {
                                method: "PUT",
                                headers: {
...
function NoClass({ msg, setShowMain, setSelectedCourse, email }) {
    ...
    async function FindClass() {
        try {
            const response = await fetch(`https://mini-project-ii-ypu6.onrender.com/class/extra`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
...
function Time({ cc, cn, sec, date, dep, sem, day, time, isRunning, setIsRunning, setShowMain, setView, numbers }) {
    ...
    async function setAttendence() {
        try {
            const response = await fetch(`https://mini-project-ii-ypu6.onrender.com/setData/setAttendence`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
